...
import { Eye, EyeOff, Mail, Lock, ArrowLeft, Loader2, Brain, Sparkles } from "lucide-react"
      ...
      <div className="flex-1 flex flex-col px-6 relative z-10">
        ...
        <div className="flex justify-center mb-6">
          <div className="relative">
            ...
            <div className="relative w-20 h-20 rounded-2xl bg-gradient-to-br from-cyan-500 to-cyan-600 flex items-center justify-center shadow-xl shadow-cyan-500/30">
