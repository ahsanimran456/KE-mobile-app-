  ...
  return (
    <div className="h-screen flex flex-col bg-[#0a0f14] relative overflow-hidden px-5">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-48 h-48 bg-teal-500/10 rounded-full blur-[80px]" />
      </div>

      {/* Header */}
      <div className="relative z-10 pt-3">
        <motion.button whileTap={{ scale: 0.9 }} onClick={() => router.push("/welcome")} className="w-8 h-8 rounded-lg bg-gray-800/80 border border-gray-700/50 flex items-center justify-center text-gray-400">
      ...
      <div className="flex-1 flex flex-col justify-center relative z-10">
        ...
        <div className="flex items-center gap-3 mb-5">
          <motion.div animate={{ y: [0, -3, 0] }} transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}>
            <svg width="44" height="50" viewBox="0 0 160 180" fill="none" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <linearGradient id="bodyGradS" x1="80" y1="40" x2="80" y2="140" gradientUnits="userSpaceOnUse">
                  <stop offset="0%" stopColor="#5EEAD4"/><stop offset="100%" stopColor="#14B8A6"/>
                </linearGradient>
                <linearGradient id="headGradS" x1="80" y1="20" x2="80" y2="90" gradientUnits="userSpaceOnUse">
                  <stop offset="0%" stopColor="#99F6E4"/><stop offset="100%" stopColor="#2DD4BF"/>
                </linearGradient>
                <linearGradient id="eyeGradS" x1="0%" y1="0%" x2="100%" y2="100%">
              ...
              <ellipse cx="30" cy="60" rx="12" ry="18" fill="url(#bodyGradS)"/>
              <ellipse cx="130" cy="60" rx="12" ry="18" fill="url(#bodyGradS)"/>
              <ellipse cx="80" cy="55" rx="45" ry="40" fill="url(#headGradS)"/>
              <ellipse cx="62" cy="52" rx="10" ry="12" fill="#0D1F1C"/>
              <ellipse cx="62" cy="52" rx="7" ry="9" fill="url(#eyeGradS)"/>
              <circle cx="64" cy="49" r="2.5" fill="white" fillOpacity="0.8"/>
              <ellipse cx="98" cy="52" rx="10" ry="12" fill="#0D1F1C"/>
              <ellipse cx="98" cy="52" rx="7" ry="9" fill="url(#eyeGradS)"/>
          ...
          <div>
            ...
            <p className="text-gray-400 text-xs">Start your AI journey</p>
          </div>
        </div>
        ...
        {/* Google */}
        <motion.button type="button" whileTap={{ scale: 0.98 }} onClick={handleGoogleSignUp} className="w-full h-12 bg-[#111820] border border-gray-700/80 hover:bg-[#1a2330] text-white rounded-2xl flex items-center justify-center gap-2.5 font-medium transition-all">
        ...
        {/* Terms + Bottom link */}
        <p className="text-center text-gray-500 text-[10px] mt-3">By signing up, you agree to our <span className="text-teal-400">Terms</span> & <span className="text-teal-400">Privacy</span></p>
